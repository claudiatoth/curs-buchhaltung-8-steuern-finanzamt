// ============================================
// TEST FINAL - Buchhaltung Teil 8: Steuern & Finanzamt (B1)
// Claudia Toth · 15 întrebări mixte
// ============================================

const finalTestData = [
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „die Steuererklärung"?', options: ['factura', 'declarația de impozit', 'salariul', 'chitanța'], correct: 'declarația de impozit', explanation: 'die Steuererklärung = declarația anuală de impozit.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „die Einkommensteuer"?', options: ['TVA', 'impozitul pe venit', 'taxa de somare', 'chiria'], correct: 'impozitul pe venit', explanation: 'die Einkommensteuer = impozitul pe venit.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „der Steuerbescheid"?', options: ['decizia de impunere de la fisc', 'o factură', 'un contract'], correct: 'decizia de impunere de la fisc', explanation: 'der Steuerbescheid = decizia de impunere (rezultatul declarației).' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Wer ist „der Steuerberater"?', options: ['consilierul fiscal', 'medicul', 'vânzătorul'], correct: 'consilierul fiscal', explanation: 'der Steuerberater = consilierul fiscal.' },
    { type: 'multiple', category: '💶 Bani', question: '„die Erstattung" bedeutet:', options: ['mai ai de plătit', 'primești bani înapoi', 'o amendă'], correct: 'primești bani înapoi', explanation: 'die Erstattung = rambursare (bani înapoi).' },
    { type: 'multiple', category: '💶 Bani', question: '„die Nachzahlung" bedeutet:', options: ['primești bani înapoi', 'mai ai de plătit la fisc', 'o reducere'], correct: 'mai ai de plătit la fisc', explanation: 'die Nachzahlung = plată suplimentară.' },
    { type: 'multiple', category: '📉 Deduceri', question: 'Was sind „Werbungskosten"?', options: ['costuri de reclamă TV', 'cheltuieli profesionale deductibile', 'TVA-ul'], correct: 'cheltuieli profesionale deductibile', explanation: 'Werbungskosten = cheltuieli legate de muncă, deductibile (drum, cursuri).' },
    { type: 'multiple', category: '📉 Deduceri', question: 'Was kann man von der Steuer absetzen?', options: ['Fahrtkosten zur Arbeit', 'das Mittagessen zu Hause', 'den Urlaub am Meer'], correct: 'Fahrtkosten zur Arbeit', explanation: 'Costurile de drum la muncă (Fahrtkosten) sunt deductibile.' },
    { type: 'multiple', category: '📅 Proceduri', question: 'Was ist „die Frist"?', options: ['termenul-limită', 'rambursarea', 'codul fiscal'], correct: 'termenul-limită', explanation: 'die Frist = termenul până la care depui declarația (de obicei 31 iulie).' },
    { type: 'multiple', category: '📅 Proceduri', question: 'Wo gibt man die Steuererklärung ab?', options: ['beim Finanzamt', 'beim Arzt', 'im Supermarkt'], correct: 'beim Finanzamt', explanation: 'Declarația se depune la Finanzamt (fiscul).' },
    { type: 'luckentext', category: '✍️ Vocabular activ', question: 'Completează:', sentence: 'Fahrtkosten kann ich von der Steuer ______. (a deduce)', translation: 'Costurile de drum le pot deduce din impozit.', accept: ['absetzen'], correct: 'absetzen', explanation: 'von der Steuer absetzen = a deduce din impozit.' },
    { type: 'luckentext', category: '✍️ Verb (Perfekt)', question: 'Completează (separabil ab-):', sentence: 'Ich habe die Steuererklärung schon ______. (abgeben)', translation: 'Am depus deja declarația de impozit.', accept: ['abgegeben'], correct: 'abgegeben', explanation: 'abgeben separabil + tare → ab-ge-geben.' },
    { type: 'luckentext', category: '✍️ Verb (Perfekt)', question: 'Completează (prefix neseparabil er-):', sentence: 'Ich habe den Steuerbescheid ______. (erhalten)', translation: 'Am primit decizia de impunere.', accept: ['erhalten'], correct: 'erhalten', explanation: 'erhalten (er- neseparabil, tare) → Perfekt fără ge-: erhalten.' },
    { type: 'multiple', category: '📝 Gramatică', question: 'Welche Perfekt-Form ist korrekt? (erstatten)', options: ['Das Amt hat geerstattet.', 'Das Amt hat erstattet.', 'Das Amt hat erstatten.', 'Das Amt ist erstattet.'], correct: 'Das Amt hat erstattet.', explanation: 'erstatten (er- neseparabil) → erstattet, fără ge-.' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was erwartet Frau Vogel für Andreea am Ende?', options: ['eine Nachzahlung', 'eine Erstattung', 'eine Strafe', 'gar nichts'], correct: 'eine Erstattung', explanation: 'Frau Vogel: „ich rechne mit einer Erstattung" — se așteaptă la bani înapoi.' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong>: vocabularul impozitelor, deducerile, procedurile la fisc și înțelegerea dialogului.</p>
