// ============================================
// PDF BUILDER — Buchhaltung Teil 8: Steuern & Finanzamt (B1)
...
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Steuern & Finanzamt (Grundwortschatz)</h1>` + t;
    }
    ...
    function buildDialog() {
        ...
        dialog1Data.replici.forEach(r => {
            const sp = r.speaker === 'andreea' ? 'Andreea 🇷🇴' : 'Frau Vogel 📋';
    ...
    function buildFlashcards() {
        let html = `<h1 class="chapter new-section">📇 4. Vocabular complet (Flashcards)</h1>
            <p style="margin-bottom:14px">Cele <strong>${typeof flashcardsData !== 'undefined' ? flashcardsData.length : 0} de carduri</strong> ale lecției — vocabularul impozitelor și al fiscului.</p>
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 5. Verb-Konjugation — verbe impozite/fisc</h1>
            <div class="theory-box warn-box"><p><strong>📌 Reamintire:</strong> Separabile (absetzen, abgeben, nachzahlen) → „-ge-" la mijloc. Neseparabile er- (erstatten, erhalten) → Perfekt FĂRĂ „ge-". abgeben (e→i) și erhalten (a→ä) sunt și tari. Präteritum = IMPERFECT.</p></div>`;
